...
//!
//! These types support the feedback collection system for Mull sessions.
//! The agent (mull-shell) uses heuristics to determine when to request feedback,
...
fn default_tier1_prompt() -> String {
    "You've been using Mull productively! Would you mind sharing quick feedback?".to_string()
}
