...
//! `mull_shell::config::{SubagentRole, SubagentPersona, PersonaIOField}`.
//!
//! Methods that remain in `mull-shell` (on `SubagentsConfig`):
...
"#;
        ...
        assert_eq!(
            ...
            Some(".mull/prompts/researcher.md")
        );
