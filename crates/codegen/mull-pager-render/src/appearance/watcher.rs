...
//!
//! In dev mode, watches ~/.mull/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.mull/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.mull/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = mull_config::user_mull_home()
