...
///
/// - `osc52_sink`: when `mull wrap` is capturing this process's output (see
...
mod tests {
    ...
    // `mull wrap` sink: a brand that does NOT natively support OSC 52 (the
    ...
    // container override is deliberately narrow; `mull wrap` is the SSH path.
    #[test]
