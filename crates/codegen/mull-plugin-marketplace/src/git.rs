...
//! Cache root: `~/.mull/marketplace-cache/<url-hash>/`
...
pub fn default_cache_root() -> PathBuf {
    mull_config::mull_home().join("marketplace-cache")
}
...
mod tests {
    ...
    fn cache_hash_is_deterministic() {
        let url = "https://github.com/palmshed/mull-plugin-marketplace.git";
    ...
    #[test]
    fn default_cache_root_under_mull() {
