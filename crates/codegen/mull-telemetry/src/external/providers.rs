...
fn build_resource(cfg: &ExternalOtelConfig) -> opentelemetry_sdk::Resource {
    let mut attrs = vec![
        ...
        opentelemetry::KeyValue::new("mull_code.schema.version", super::schema::SCHEMA_VERSION),
    ];
    ...
    opentelemetry_sdk::Resource::builder_empty()
        // RQ6 (final): `mull-cli`, a wire commitment.
...
mod tests {
    ...
    fn exporter_metadata_is_customer_headers_only() {
        ...
        for forbidden in ["x-palmshed-token-auth", "x-userid", "x-teamid"] {
