...
//! Mull to persist important information across sessions. Memory files are
//! stored under `~/.mull/memory/` with workspace-scoped subdirectories
...
//! `MULL_MEMORY=1` environment variable. When disabled, this crate
