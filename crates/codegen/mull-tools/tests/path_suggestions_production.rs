...
//! Run:
//! ```bash
//! cargo test -p mull-tools --test path_suggestions_production
//! ```

use mull_tools::util::path_suggestions::{format_not_found_error, path_not_found_hint};
...
fn similar_names(hint: &mull_tools::util::path_suggestions::PathNotFoundHint) -> Vec<String> {
    hint.similar
        .iter()
...
#[tokio::test]
async fn pattern2_mull_sessions_internal_path() {
