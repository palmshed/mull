...
use crate::implementations::mull_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::mull_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::mull_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::mull_build::grep::GrepSearchInput;
use crate::implementations::mull_build::image_edit::ImageEditInput;
use crate::implementations::mull_build::image_gen::ImageGenInput;
use crate::implementations::mull_build::list_dir::ListDirInput;
use crate::implementations::mull_build::read_file::ReadFileInput;
use crate::implementations::mull_build::search_replace::SearchReplaceInput;
use crate::implementations::mull_build::todo::TodoWriteInput;
use crate::implementations::mull_build::update_goal::UpdateGoalInput;
use crate::implementations::mull_build::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::mull_build::web_fetch::WebFetchInput;
use crate::implementations::mull_build::web_search::WebSearchInput;
...
use mull_tool_types::KillTaskToolInput;
use mull_tool_types::TaskOutputToolInput;
use mull_tool_types::TaskToolInput;
use mull_tool_types::WaitTasksToolInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::mull_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::mull_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::mull_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::mull_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::mull_build::scheduler::list::SchedulerListInput),
