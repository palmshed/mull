...
impl mull_tool_runtime::Tool for SearchTool {
    type Args = SearchToolInput;
    type Output = ToolOutput;

    fn id(&self) -> mull_tool_protocol::ToolId {
        mull_tool_protocol::ToolId::new("search_tool").expect("valid tool id")
    }
...
mod tests {
    ...
    fn hash_value_pinned_output() {
        ...
        let h = hash_value(&"mull-mcp-fingerprint-stability-test");
        assert_eq!(h, hash_value(&"mull-mcp-fingerprint-stability-test"));
