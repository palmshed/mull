...
impl mull_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl mull_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> mull_tool_protocol::ToolId {
        mull_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, mull_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                mull_tool_runtime::ToolError::execution(
                    mull_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
