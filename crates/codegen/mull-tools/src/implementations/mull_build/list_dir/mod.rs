...
crate::register_resource!("mull_build", "ListDir", ListDirParams);
...
impl mull_tool_runtime::Tool for ListDirTool {
...
mod tests {
    ...
    fn tool_name_and_description() {
        ...
        let tool = ListDirTool;
        assert_eq!(mull_tool_runtime::Tool::id(&tool).as_str(), "list_dir");
