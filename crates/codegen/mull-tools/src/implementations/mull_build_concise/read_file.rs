...
impl crate::types::tool_metadata::ToolMetadata for ReadFileConciseTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::MullBuildConcise
    }
...
impl mull_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // MullBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::mull_build::read_file::ReadFileTool;
