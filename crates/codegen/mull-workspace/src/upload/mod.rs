...
use mull_auth::{AuthCredentialProvider, CredentialSnapshot};
use mull_computer_hub_sdk::auth::{AuthCredential, AuthProvider};
use mull_file_utils::gcs::StorageConfig;
use mull_file_utils::queue::{EnqueueOutcome, TraceExportSource, UploadQueue};
use mull_file_utils::storage_client::Auth401AttributionCallback;
use mull_file_utils::{TraceExportConfig, UploadMethod};
...
static UPLOAD_QUEUE_PENDING_BYTES: LazyLock<IntGauge> = LazyLock::new(|| {
    register_int_gauge!(
        "mull_workspace_upload_queue_pending_bytes",
...
static UPLOAD_QUEUE_PENDING: LazyLock<IntGauge> = LazyLock::new(|| {
    register_int_gauge!(
        "mull_workspace_upload_queue_pending",
...
static UPLOAD_OUTCOME_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "mull_workspace_upload_outcome_total",
...
static UPLOAD_FAILED_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "mull_workspace_upload_failed_total",
...
static UPLOAD_SKIPPED_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "mull_workspace_upload_skipped_total",
...
impl mull_auth::visibility::HttpAuth for HubAuthCredentialProvider {
...
mod tests {
    use super::*;
    use mull_computer_hub_sdk::auth::AuthCredential;
