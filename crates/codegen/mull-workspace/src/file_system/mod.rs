...
// its wire types live in `mull_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use mull_workspace_types::rpc::fs::FsReadEncoding;
...
pub use mull_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
