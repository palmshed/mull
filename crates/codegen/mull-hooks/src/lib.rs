//! # mull-hooks
//!
//! Runtime hook system for Mull — file-based discovery, command execution,
//! and policy enforcement.
//!
//! ## Overview
//!
//! This crate provides a minimal hooks system for Mull. Hooks are discovered
//! from dedicated directories (`~/.mull/hooks/` and `<git-worktree-root>/.mull/hooks/`),
...
//!     Some(Path::new("/home/user/.mull/hooks")),
//!     Some(Path::new("/project/.mull/hooks")),
//! );
//!
//! for err in &errors {
