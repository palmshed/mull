...
//!
//! ```text
//! cargo bench -p mull-pager --bench edit_highlight
//! cargo bench -p mull-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use mull_pager::diff::{DiffHunk, DiffLine};
use mull_pager::scrollback::blocks::tool::{
...
use mull_pager::syntax::{Syntect, get_syntect};
