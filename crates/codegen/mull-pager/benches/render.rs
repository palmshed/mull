//! Criterion benchmarks for the mull-pager rendering pipeline.
//!
...
use mull_pager::scrollback::render::render_scrolled_entries_with_scratch;
use mull_pager::scrollback::wrappers::EntryRenderer;
use mull_pager::scrollback::{
