...
pub mod detection {
    pub use mull_file_utils::workspace_classifier::is_project_dir;
}
pub mod sources;
...
pub fn build_project_question(
    ...
    ProjectQuestion {
        question: Question {
            question: "Run Mull in a project directory?\n\n\
                 This gives Mull full context of your codebase for better results."
                .into(),
            id: None,
            options,
