...
/// Online Build docs landing page (hardcoded like other TUI deep-links; docs.palmshed.ai can redirect if the path moves).
pub const BUILD_DOCS_URL: &str = "https://docs.palmshed.ai/build/overview";
    ...
    fn suggest_args(&self, _ctx: &AppCtx, _args_query: &str) -> Option<Vec<ArgItem>> {
        let mut items = vec![
            ...
            ArgItem {
                ...
                description: "Open docs.palmshed.ai/build in the browser".into(),
            },
        ];
