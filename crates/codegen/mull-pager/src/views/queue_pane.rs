...
pub enum QueueRowOrigin {
    ...
    /// while running). Edits route to the agent as `palmshed.ai/queue/*`.
    Server,
}
...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. MullNight's dark band leaking into MullDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default MullNight, dark) after the user switches —
        // painting a dark band on a light MullDay canvas.
