...
const HERO_SUBTITLE: &str = "Thanks for trying Mull, give feedback with /feedback!";
...
pub(super) fn compute_hero_box(
    ...
    announcement: Option<&mull_announcements::RemoteAnnouncement>,
    expanded: bool,
...
managed devices and accounts. Report security incidents";
    ...
    fn ann(title: Option<&str>, message: Option<&str>) -> mull_announcements::RemoteAnnouncement {
    ...
    fn upgrade_cta_reserves_rows_and_returns_button_rect() {
        ...
        let a = ann(None, Some("Mull 4.5 is here. Upgrade now."));
        ...
        let mut pinned = ann(None, Some("Mull 4.5 is here. Upgrade now."));
        pinned.dismissible = Some(false);
        pinned.cta = Some(mull_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://palmshed.ai/grok".into()),
        ...
        let mut dismissible = ann(None, Some("Mull 4.5 is here. Upgrade now."));
        dismissible.cta = Some(mull_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://palmshed.ai/grok".into()),
            caption: Some("or use Ctrl+O".into()),
        });
