...
//! render mode.
//!
//! `mull-pager` cannot depend on `mull-pager-minimal`: that crate reads
...
//!
//! The composition-root binary (`mull-pager-bin`) wires it up once at
//! startup by calling `mull_pager_minimal::install()`. When nothing has
