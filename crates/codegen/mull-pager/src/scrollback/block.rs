...
impl RenderBlock {
    ...
    pub fn context_info(
        snapshot: mull_shell::session::ContextInfo,
    ...
    pub fn with_hyperlinks<R>(&self, f: impl FnOnce(&[mull_markdown::HyperlinkTarget]) -> R) -> R {
        match self {
...
mod searchable_text_tests {
    ...
    use mull_shell::session::ContextInfo;
    ...
    fn subagent_failed_indexes_metadata_and_error() {
        ...
        assert!(text.contains("mull-test"), "got: {text:?}");
