...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Open plain mull in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Open plain mull in scrollback-native (minimal) mode.",
    },
];
...
//
// Concrete codes must match `mull_voice::STT_LANGUAGES` (official Mull STT
// catalog — https://docs.palmshed.ai/developers/model-capabilities/audio/speech-to-text).
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "How plain mull opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "mullnight".
                default: "mullnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "mullnight".
                default: "mullnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "mullday".
                default: "mullday",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
        ...
        SettingMeta {
            ...
            keywords: &["model", "default", "agent", "llm", "mull", "switch"],
        ...
        // The `MULL_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        SettingMeta {
            ...
            description: "Controls whether Palmshed may retain and train on coding session data.",
            keywords: &[
                "privacy",
                "data",
                "sharing",
        ...
        // follows the process locale when it maps to a Mull STT language.
        // Catalog = official STT languages (see mull_voice::STT_LANGUAGES).
        SettingMeta {
            key: "voice_stt_language",
            category: SettingCategory::Editor,
            owner: SettingOwner::Shell,
            label: "Voice language",
            description: "Speech-to-text language for voice dictation (Mull STT). \
