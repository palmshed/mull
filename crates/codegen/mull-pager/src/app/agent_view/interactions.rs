...
impl AgentView {
        ...
        match qv.focus {
            ...
            QuestionFocus::Navigation => {
                ...
                match key.code {
                    ...
                    KeyCode::Char('z') if key.modifiers.is_empty() && !qv.no_freeform => {
                    ...
                    KeyCode::Char('y') if key.modifiers.is_empty() && !qv.is_on_freeform_row() => {
                        let cursor = qv.cursor();
                        let active = qv.active_tab;
    ...
    fn submit_question_answers(&mut self, skipped: bool) -> InputOutcome {
        use mull_tools::implementations::mull_build::ask_user_question::AskUserQuestionExtResponse;
        self.swap_question_freeform();
        ...
        mull_telemetry::session_ctx::log_event(mull_telemetry::events::PlanSubmit {
...
mod permission_scope_key_tests {
    ...
    fn setup_bash_permission(agent: &mut AgentView) {
        ...
        perm.bash_highlights = Some(
            mull_workspace::permission::bash_command_splitting::BashCommandHighlights {
                prefix: vec![],
...
mod question_no_freeform_tests {
    ...
    //! the SuperMull upsell. Regression tests for the bug where clicking
    ...
    fn upsell_question() -> Question {
        ...
        Question {
            ...
            options: vec![
                opt("Upgrade to SuperMull", "For everyday coding"),
                opt("Upgrade to SuperMull Heavy", "Highest usage limits"),
            ],
