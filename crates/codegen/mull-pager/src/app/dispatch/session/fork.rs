...
-> [mull_tools::implementations::mull_build::ask_user_question::QuestionOption; 2] {
    use mull_tools::implementations::mull_build::ask_user_question::QuestionOption;
    [
        QuestionOption {
...
/// [`Effect::ForkSession`] which calls `palmshed.ai/session/fork` directly.
