...
fn plugins_list_response() -> mull_hooks_plugins_types::PluginsListResponse {
    use crate::views::extensions_modal::test_plugin_info;
    mull_hooks_plugins_types::PluginsListResponse {
        plugins: vec![
            test_plugin_info(
                "user-tool",
                Some(mull_hooks_plugins_types::PluginOrigin::UserMull),
            ),
            test_plugin_info(
                "claude-tool",
                Some(mull_hooks_plugins_types::PluginOrigin::UserClaude),
            ),
        ],
    }
}
