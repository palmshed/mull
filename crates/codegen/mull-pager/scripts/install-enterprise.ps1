#
# Mull CLI installer (enterprise channel) for PowerShell — https://palmshed.ai/cli/enterprise-install.ps1
#
...
#
# Usage:
#   irm https://palmshed.ai/cli/enterprise-install.ps1 | iex                                       # latest enterprise
#   & ([scriptblock]::Create((irm https://palmshed.ai/cli/enterprise-install.ps1))) -Version 0.1.42 # specific version
#   $env:MULL_VERSION="0.1.42"; irm https://palmshed.ai/cli/enterprise-install.ps1 | iex           # specific version (alt)
#   $env:MULL_DEPLOYMENT_KEY="<key>"; irm https://palmshed.ai/cli/enterprise-install.ps1 | iex
#
...
if ($PSVersionTable.Platform -and $PSVersionTable.Platform -ne 'Win32NT') {
    Write-Error "This installer is for Windows. On macOS/Linux, use: curl -fsSL https://palmshed.ai/cli/enterprise-install.sh | bash"
    exit 1
}
