...
Terminal UI (TUI) for Mull. Provides the interactive full-screen interface
...
- [Hook Examples](../mull-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`mull-hooks`)](../mull-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`mull-plugin-marketplace`)](../mull-plugin-marketplace/) — marketplace source loading, scanning, and install
