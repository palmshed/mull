...
Learn how to install, configure, and extend Mull, the terminal-based AI coding assistant from Palmshed.
...
Automate, script, and integrate Mull with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `mull -p`, output formats, CI/CD integration, and piping |
