# @palmshed/mull-darwin-arm64

Platform-specific binary for [`@palmshed/mull`](https://www.npmjs.com/package/@palmshed/mull) on darwin-arm64.

Do not install this package directly. Install the main package instead:

```sh
npm install -g @palmshed/mull
```
