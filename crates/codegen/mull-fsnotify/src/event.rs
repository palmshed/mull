//! Public event types — the wire contract for `mull-fsnotify`.
//!
...
//! translator (in `mull-workspace`) maps these to
...
/// Aligned with `mull_workspace_types::FsEventKind` (identity map at
