...
use mull_pager::appearance::AppearanceConfig;
use mull_pager::minimal_api;
use mull_pager::render::Renderable;
use mull_pager::scrollback::block::RenderBlock;
use mull_pager::scrollback::blocks::ToolCallBlock;
use mull_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use mull_pager::theme::cache as theme_cache;
        use ratatui::buffer::Buffer;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                mull_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
