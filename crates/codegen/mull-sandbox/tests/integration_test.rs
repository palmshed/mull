//! Integration tests for mull-sandbox.
//!
...
fn test_sandbox_logger() {
    use mull_sandbox::{SandboxEvent, SandboxLogger};
...
fn test_should_restrict_child_network_default() {
    ...
    assert!(!mull_sandbox::should_restrict_child_network());
}
