//! Config file loading for Mull.
//!
//! Merge order (lowest → highest priority):
//! 1. `/etc/mull/managed_config.toml`
//! 2. `$MULL_HOME/managed_config.toml`
//! 3. `$MULL_HOME/config.toml`
//! 4. `$MULL_HOME/requirements.toml` (cloud cache; Ed25519-signed at rest once a
//!    key is embedded — see [`signed_policy`] — below the OS-protected layers)
//! 5. `/etc/mull/requirements.toml`
//! 6. macOS MDM managed preferences (`io.palmshed.mull`, admin-forced) — macOS only
//!
...
pub use paths::{
    ...
    default_mull_home, encode_cwd_dirname, ensure_sessions_cwd_dir, mull_application,
    mull_application_in, mull_home, sessions_cwd_dir, system_config_dir, user_mull_home,
};
pub use validation::{
