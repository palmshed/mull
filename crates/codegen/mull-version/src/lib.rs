//! Installed mull CLI version, lockstepped with shipping binaries.

use semver::Version;

pub const TEST_VERSION_ENV: &str = "MULL_TEST_VERSION";

pub const VERSION: &str = match option_env!("MULL_VERSION") {
    Some(v) => v,
