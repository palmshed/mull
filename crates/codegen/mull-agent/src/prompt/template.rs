...
/// The base prompt template source, exposed for `mull prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `mull prompt --section apply-patch-template`.
...
mod tests {
    ...
    /// Build a TemplateRenderer with the standard mull-build tool kinds.
