...
/// Claude.md / `.mull/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.mull` and compat dirs.
...
/// Mirrors the serde shape of `mull-agent`'s `AgentConfigFile`.
