//! mull-sampler - Actor-based sampling layer for Palmshed mull.
//!
//! This crate extracts the HTTP streaming + retry logic out of
//! `mull-shell`'s session actor into a standalone, reusable
//! component built on the same actor pattern as `mull-hunk-tracker`.
//!
//! ## Layered API
//!
