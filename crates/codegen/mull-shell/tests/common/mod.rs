//! Shared helpers for mull-shell integration tests.

use mull_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `mull_sampler::SamplingClient`, which takes a
