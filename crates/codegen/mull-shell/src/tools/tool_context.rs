...
//! mull-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use mull_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use mull_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn mull_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<mull_tools::implementations::mull_build::task::types::MonitorEventBuffer>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = mull_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
