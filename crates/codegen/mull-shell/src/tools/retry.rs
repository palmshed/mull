//! Retry utilities — re-exported from `mull-tools`.
//!
//! The canonical implementation now lives in `mull_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use mull_tools::retry::BackoffConfig as RetryConfig;
pub use mull_tools::retry::{BackoffConfig, execute_with_backoff};
