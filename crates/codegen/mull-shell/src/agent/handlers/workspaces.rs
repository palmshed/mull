...
mod tests {
    ...
    #[test]
    fn success_response_projects_mull_workspace_fields() {
    ...
    fn degraded_response_carries_partial_reason() {
        ...
        assert_eq!(value["_meta"]["palmshed.ai/partial"]["workspaces"], true);
        assert_eq!(value["_meta"]["palmshed.ai/partial"]["reason"], "no_oauth");
    }
}
