...
/// JSON-RPC wrapper for Palmshed extension notifications.
#[derive(Debug, Serialize)]
...
const PALMSHED_SESSION_UPDATE_METHOD: &str = "_palmshed.ai/session/update";
        ...
        updates
            ...
            .map(|update| match update {
                ...
                SessionUpdate::Mull(notification) => {
                    ExportedMessage::from_mull_notification(notification)
                }
            })
            .collect()
    }
