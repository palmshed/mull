...
impl SessionActor {
    ...
    /// sees "Mull is thinking", streaming token chunks, or any other
    ...
    pub(crate) async fn maybe_fire_laziness_check(self: Arc<Self>) {
        ...
        let request = ConversationRequest {
            ...
            // other tool-flavoured Mull variants) reject the field at
            ...
            x_mull_conv_id: Some(session_id_str.clone()),
            x_mull_req_id: Some(format!("{LAZINESS_REQ_ID_PREFIX}{}", uuid::Uuid::new_v4())),
            x_mull_session_id: Some(session_id_str),
