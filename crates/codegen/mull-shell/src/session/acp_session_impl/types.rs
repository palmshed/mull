...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<mull_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(mull_tools::implementations::mull_build::update_goal::UpdateGoalInput),
    Channel(mull_tools::implementations::mull_build::update_goal::UpdateGoalEnvelope),
}
