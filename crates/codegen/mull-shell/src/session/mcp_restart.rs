...
//! window containing a [`mull_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`mull_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`mull_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`mull_mcp::servers::ClientStateKind::Empty`]
...
use mull_mcp::servers::{McpClientEventKind, McpServerName};
...
pub trait RestartActions {
    ...
    /// Push an already-built `palmshed.ai/mcp/server_status` payload to the
...
/// ACP `palmshed.ai/mcp/server_status` notification. Failures are logged and
