...
//!
//! The canonical types now live in `mull_sampling_types::conversation`.
//! This module re-exports them and adds mull-shell-specific types
//! (`ConversationRequestTrace`) that depend on internal crate types.

// Re-export everything from the standalone crate.
pub use mull_sampling_types::conversation::*;

// ============================================================================
// mull-shell-specific types (depend on internal crate types)
// ============================================================================

/// Tracing context for conversation requests.
///
/// Stays in `mull-shell` because it references
...
// via `Box::new(trace)`.
//
// Tests for conversation types now live in mull-sampling-types crate.
