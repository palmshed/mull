...
use super::super::MullAuth;
use super::protocol::{OidcError, OidcUserInfo, build_mull_auth, discover, refresh_tokens};
...
pub(crate) async fn oidc_token_exchange(auth: &MullAuth) -> OidcRefreshResult {
    ...
    let mut new_auth = build_mull_auth(tokens, user_info, issuer, client_id);
