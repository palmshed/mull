...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&MullAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> mull_telemetry::events::AuthTokenKind {
        use mull_telemetry::events::AuthTokenKind as K;
        match self {
