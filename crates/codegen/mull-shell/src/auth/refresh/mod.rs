...
pub(crate) trait ExternalCommandRunner: Send + Sync {
    ...
    fn run_external_command(&self, command: &str) -> Option<MullAuth>;
}
...
impl RefreshOutcome {
    ...
    pub(crate) fn success(auth: MullAuth) -> Self {
...
mod tests {
    use super::*;
    use crate::auth::{AuthMode, MullAuth, MullComConfig};
