...
//!
//! Provides access to the mull-hunk-tracker functionality for tracking file changes
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        ...
        // Queries
        // ───────────────────────────────────────────────────────────────
        "palmshed.ai/hunk-tracker/get-hunks" => {
        ...
        "palmshed.ai/hunk-tracker/get-files" => {
        ...
        "palmshed.ai/hunk-tracker/get-all-file-contents" => {
            let req = parse_params::<GetFilesRequest>(args)?;
        ...
        "palmshed.ai/hunk-tracker/get-summary" => {
        ...
        // Single Hunk Action
        // ───────────────────────────────────────────────────────────────
        "palmshed.ai/hunk-tracker/hunk-action" => {
        ...
        // Bulk Actions
        // ───────────────────────────────────────────────────────────────
        "palmshed.ai/hunk-tracker/file-action" => {
        ...
        "palmshed.ai/hunk-tracker/turn-action" => {
        ...
        "palmshed.ai/hunk-tracker/all-action" => {
