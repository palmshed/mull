...
use mull_workspace::file_system::ContentSearchRequest as ContentSearchRequestParams;
use mull_workspace::workspace_ops::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    match args.method.as_ref() {
        ...
        "palmshed.ai/search/fuzzy/close" => {
        ...
        "palmshed.ai/search/content" => {
            ...
            // `palmshed.ai/search/content/status` batches through the client sink.
