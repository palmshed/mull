//! `palmshed.ai/rewind/*` extension handlers.
//!
...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    ...
    match args.method.as_ref() {
        "palmshed.ai/rewind/execute" => handle_execute(agent, args).await,
        "palmshed.ai/rewind/points" => handle_points(agent, args).await,
