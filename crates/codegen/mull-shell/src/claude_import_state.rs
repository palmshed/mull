...
//
// State is persisted to `~/.mull/claude_import_state.json`.
...
use mull_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.mull/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::mull_home::mull_home().join("claude_import_state.json")
}
