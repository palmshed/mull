...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "MULL_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "MULL_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`MULL_MIN_DRAW_MS` / `MULL_SCROLL_CADENCE_MS`).
