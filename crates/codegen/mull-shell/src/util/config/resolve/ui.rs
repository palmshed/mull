...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "MULL_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`MULL_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "MULL_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`MULL_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "MULL_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`MULL_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `MULL_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("MULL_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes MULL_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
