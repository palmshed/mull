//! Mull Speech-to-Text language codes.
//!
//! Source of truth for the `language` query/form parameter on
//! `https://api.palmshed.ai/v1/stt` and `wss://api.palmshed.ai/v1/stt`.
//!
//! Official catalog (25 languages):
//! <https://docs.palmshed.ai/developers/model-capabilities/audio/speech-to-text#supported-languages>
//!
...
/// Official Mull STT languages (docs.palmshed.ai), sorted by English name.
///
...
mod tests {
    ...
    fn catalog_matches_public_docs_exactly() {
        ...
        assert_eq!(
            ours, docs,
            "STT_LANGUAGES drifted from docs.palmshed.ai supported languages"
        );
    }
