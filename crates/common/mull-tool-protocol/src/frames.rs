...
pub struct ToolCallResult {
    ...
    /// this crate must not depend on `mull-tool-runtime`. Sampler-side wire
...
/// `mull_computer_hub_core::registry::ToolSessionBindOutcome`, with one
...
pub struct ToolsListResult {
    pub tools: Vec<mull_tool_types::ToolDescription>,
}
