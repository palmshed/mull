...
pub struct BeforeTurnPayload {
    ...
    /// (`"primary"` | `"subagent"`). A `String`, not the `mull-file-utils`
...
pub struct AfterTurnPayload {
    ...
    /// the workspace decodes it into the `mull-file-utils`
