...
//! string/text manipulation. Harness-bound extraction (Mull chat's
//! `MullConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `MullMessage` assembly) stays in the harness crate.
