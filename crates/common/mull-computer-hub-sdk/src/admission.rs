...
/// Numeric JSON-RPC code for overload rejection (`mull-tool-protocol`
...
const GLOBAL_MAX_INFLIGHT_ENV: &str = "PALMSHED_TOOL_SERVER_GLOBAL_MAX_INFLIGHT";
...
/// `PALMSHED_TOOL_SERVER_GLOBAL_MAX_INFLIGHT` when present and parseable as a
