...
fn map_block(block: mull_tool_protocol::McpBlock) -> ContentBlock {
    use mull_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: mull_tool_protocol::JsonRpcError) -> ToolError {
