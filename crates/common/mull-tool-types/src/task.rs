...
/// A built-in subagent type shared by the CLI (`mull-agent`) and other
...
mod tests {
    ...
    // match what the mull-shell MiniJinja templates render for the default
    // mull-build toolset (monitor + task + bash + read present, POSIX). The
