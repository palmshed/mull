//! Unified MCP adapter for the Palmshed Computer Hub.
//!
...
//! tools, and produces [`ToolServerHandler`](mull_computer_hub_sdk::ToolServerHandler)
//! implementations that can be registered with a hub
//! [`ToolServerBuilder`](mull_computer_hub_sdk::ToolServerBuilder).
//!
//! # Architecture
//!
//! ```text
