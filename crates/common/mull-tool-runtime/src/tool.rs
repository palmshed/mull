...
/// `filename`, `path`, `metadata`) that the Mull SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the Mull SLOP converter to
    ...
    /// - `path`: file path on the Mull Computer filesystem
